    ...
    <v-card class="elevation-12 ma-auto mt-30% pa-5" height="auto" width="50%">
      ...
      <v-card-text>
        <v-form ref="form" lazy-validation>
          ...
          <p v-if="errorMessaage" class="red--text">
      ...
      <v-card-actions>
        <v-col>
          ...
          <v-layout align-center="true" justify-center>
            <v-btn dark color="green" @click="forgotPassword"
...
export default {
  ...
  created() {
    ...
    if (storage.getItem("kitabUserType") != null) {
      console.log(storage.getItem("kitabUserType"));
      this.$router.push("/" + storage.getItem("kitabUserType"));
    }
  },
};
</script>
